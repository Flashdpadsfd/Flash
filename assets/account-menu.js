...
(function () {
  ...
  function injectStyles() {
    ...
    var css =
      '.fs-acc{position:relative;display:inline-block;font-family:var(--font-ui,Manrope,sans-serif);}' +
      ...
      '.fs-acc__item{display:flex;align-items:center;gap:10px;width:100%;text-align:left;padding:9px 12px;border-radius:9px;cursor:pointer;' +
        'background:none;border:none;color:rgba(255,255,255,.85);font-size:14px;font-family:var(--font-ui,Manrope,sans-serif);text-decoration:none;}' +
